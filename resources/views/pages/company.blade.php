                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <input type="file" class="file_ttd" name="file" required multiple data-max-file-size="2MB">
                            </div>
                        </div>
...
<script>
    ...
    function updateProject(){
        ...
        let apiUrl = `http://doc-center-backend.test/api/v1/admin-doc-categories/${id_project}`;
    ...
    function submitPostForm(formData) {
        ...
        let apiUrl = `http://doc-center-backend.test/api/v1/admin-doc-categories`;
