        ...
        <div class="card-header text-right">
            <div class="row">
                ...
                <div class="col-sm-4 d-flex justify-content-end align-items-center">
                    <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#formModal"><i class="fa-solid fa-plus"></i> Add</a>
                </div>
            </div>
        </div>
        <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <form action="#" id="activityForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text"class="form-control" name="project_id" id="project_id" style="display: none">
...
@include('ajax.activityByProjectAjax')
@endsection
