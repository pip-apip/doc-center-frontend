...
<section class="section">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-sm-8">
                    <h1>Activity {{ $status === 'create' ? 'Add' : 'Edit' }} Form</h1>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            @endif
                ...
                <div class="form-group">
                    <input type="text" placeholder="Enter the Activity Title" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{ old('title', $activity ? $activity['title'] : '') }}">
                    @error('title')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
