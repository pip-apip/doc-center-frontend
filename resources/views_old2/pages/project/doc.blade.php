...
<section class="section">
    <div class="card">
        <div class="card-header text-right">
            <h1>Form Document Administration Project</h1>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="file-upload-wrapper" id="dropzone">
                                <label for="file-upload" class="file-upload-area {{ $errors->has('file') ? 'is-invalid' : '' }}">
                        ...
                        <div class="col-sm-2 d-flex justify-content-center align-items-center">
                            <button class="btn btn-success" type="submit" style="margin: 0 auto"><i class="fa-solid fa-plus"></i> Add</button>
                        </div>
                    </div>
                </div>
            </form>
...
<section class="section">
    <div class="card">
        <div class="card-header text-right">
            <h1>Document Administration Project</h1>
        </div>
        <div class="card-body">
            <label><b> Category : </b></label>
            <fieldset class="form-group">
