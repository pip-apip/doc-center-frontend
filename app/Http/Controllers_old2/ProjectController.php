...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.project.index', compact('projects'))->with(['title' => 'project']);
    }
    ...
    public function show(string $id)
    {
        ...
        $responseDocProject = Http::withToken($accessToken)->get('https://bepm.hanatekindo.com/api/v1/admin-docs/search?project_id='.$id);
